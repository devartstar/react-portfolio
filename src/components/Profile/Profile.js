...
import Profilepic from "../../assets/images/MAIN-COVER.jpg";
    ...
    return (
        <div className="profile container_shadow">
            ...
            <div className='profile_information'>
                <CustomTimeline icon={<PeopleOutlineIcon />} >
                    <CustomTimelineItem
                        title='Name' text={resumeData.name}
                    />
                    <CustomTimelineItem
                        title='Title' text={resumeData.title}
                    />
                    <CustomTimelineItem
                        title='Email' text={resumeData.email}
                    />
                    {
