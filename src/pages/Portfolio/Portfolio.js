    ...
    return (
        <Grid container spacing={1} className='section pb_45 pt_45'>
                                                ...
                                                <Card className='customCard' onClick={() => setProjectDialog(project)}>
                                                    <CardActionArea>
                                                        ...
                                                        <CardContent>
                                                            ...
                                                            <Typography variant='body2' className='customCard_captionfDialog'>{project.captionfDialog}</Typography>
                                                        </CardContent>
                                                    </CardActionArea>
                                                </Card>
                                            </Grow>
            ...
            <Dialog open={projectDialog} onClose={() => setProjectDialog(false)} className='projectDialog'>
                ...
                <img src={projectDialog.image} alt='Project ss' className='projectDialog_image' />
                <DialogContent>
                    <Typography className='projectDialog_description'>{projectDialog.desrciption}</Typography>
                </DialogContent>
