    ...
    return (
        <>
            ...
            <Grid container className='section pb_45'>
                <Grid item className='section_title mb_30'>
                    <span></span>
                    <h6 className='section_title_text'>Experiences</h6>
                </Grid>
                <Grid item xs={12}>
            ...
            {/* Skills */}
            <Grid container spacing={3} className='section graybg pb_45 p_50' justify='space-between'>
                ...
                <Grid item xs={12} lg={5}>
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <Grid container>
                                <Grid item xs={12}>
                                    <Typography className='contactsInfo_items'>
